                ...
                {items.map((item) => (
                  <div key={item.id} className="flex items-start gap-4 py-6 first:pt-0">
                    ...
                    <button
                      ...
                      className="mt-4 text-muted-foreground hover:text-foreground transition-colors flex-shrink-0"
              ...
              <div className="border-t border-border pt-6 mt-2">
                ...
                <div className="flex gap-3">
                  <input
                    ...
                    className="flex-1 max-w-xs bg-card border border-border text-sm rounded-xl py-2.5 px-4 outline-none focus:ring-2 focus:ring-ring/20 transition-all placeholder:text-muted-foreground"
                  />
                  <button
