  ...
  return (
    <section className="font-display px-4 md:px-0">
      <div className="flex items-center justify-between mb-4 md:mb-8">
        ...
        <span className="md:hidden material-symbols-outlined text-slate-400">
          tune
        </span>
      </div>
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
        {recommended.map((item, i) => (
          <div
            key={i}
            className="bg-white dark:bg-slate-900 rounded-xl overflow-hidden border border-slate-100 dark:border-slate-800 hover:shadow-xl transition-all group"
          >
            ...
            <div className="p-5 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1 bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded text-[10px] font-bold">
                  ...
                  <span className="material-symbols-outlined text-[12px] text-orange-400 fill-1">
                    star
                  </span>
                </div>
              </div>
              <h4 className="font-bold text-slate-800 dark:text-white group-hover:text-brand-primary transition-colors">
                {item.name}
              </h4>
