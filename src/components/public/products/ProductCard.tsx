  ...
  return (
    <div className="group relative flex flex-col rounded-xl bg-white dark:bg-slate-800 p-4 shadow-sm transition-all hover:shadow-xl hover:-translate-y-1 font-display">
      ...
      <div className="flex flex-col flex-1">
        <span className="text-[10px] md:text-xs font-bold text-brand-primary uppercase mb-1">
          {product.brand}
        </span>
        <h3 className="text-sm md:text-lg font-bold text-slate-900 dark:text-white leading-tight mb-1 md:mb-2 line-clamp-1 md:line-clamp-none">
          {product.name}
        </h3>
